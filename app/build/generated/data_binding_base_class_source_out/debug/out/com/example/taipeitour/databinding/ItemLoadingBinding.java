...
public final class ItemLoadingBinding implements ViewBinding {
  ...
  private ItemLoadingBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar pbBar) {
  ...
  public static ItemLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.pb_bar;
      ProgressBar pbBar = ViewBindings.findChildViewById(rootView, id);
      if (pbBar == null) {
        break missingId;
      }

      return new ItemLoadingBinding((LinearLayout) rootView, pbBar);
    }
